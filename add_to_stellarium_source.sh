...
rm -rf "$SRC/plugins/VisibilityContours"
mkdir -p "$SRC/plugins/VisibilityContours"
cp -a "$HERE/CMakeLists.txt" "$HERE/src" "$SRC/plugins/VisibilityContours/"

if ! grep -q 'ADD_PLUGIN(VisibilityContours' "$SRC/CMakeLists.txt"; then
...
echo "Installed source into: $SRC/plugins/VisibilityContours"
echo "Registered: ADD_PLUGIN(VisibilityContours 1)"
